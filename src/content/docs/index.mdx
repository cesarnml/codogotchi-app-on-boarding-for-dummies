...
<CardGrid>
  ...
  <Card title="Reference (14–18)" icon="laptop">
    Dev helpers, platform APIs (NSPanel, SpriteKit, AppKit), the procedural-effects engine, the ~/.codogotchi disk contract, and the App Store requirements primer.
  </Card>
