...
`onReady`/`onQuit`. **Ours:** [`MenubarApp.swift:12`](../../../apps/menubar/Sources/MenubarApp.swift)
(`@main final class MenubarApp: NSObject, NSApplicationDelegate`); the giant
`applicationDidFinishLaunching` ([:102](../../../apps/menubar/Sources/MenubarApp.swift))
...
(menu-bar) app at launch. **Ours:** [`MenubarApp.swift:98`](../../../apps/menubar/Sources/MenubarApp.swift).
...
**Ours:** created at [`MenubarApp.swift:103`](../../../apps/menubar/Sources/MenubarApp.swift);
the pet image is pushed into `item.button?.image` by `MenubarRenderer`'s sink
([:167](../../../apps/menubar/Sources/MenubarApp.swift)); the failure tooltip is
`item.button?.toolTip` ([:295](../../../apps/menubar/Sources/MenubarApp.swift)).
🇹🇸 ≈ Electron `Tray` — `setImage`, `setToolTip`, `setContextMenu`.
⚠️ **Gotcha:** the status item is `var statusItem` held strongly on the delegate
([:15](../../../apps/menubar/Sources/MenubarApp.swift)) — drop the reference and
...
**Ours:** [`MenubarMenu.swift:47`](../../../apps/menubar/Sources/MenubarMenu.swift)
...
someone (`var menuBuilder` on the delegate, [:62](../../../apps/menubar/Sources/MenubarApp.swift))
...
[`FloatingPetPanel.swift:645`](../../../apps/menubar/Sources/FloatingPetPanel.swift):
...
in [`AppState.swift`](../../../apps/menubar/Sources/AppState.swift)
(`FloatingFramePolicy.clamp`) keeps the pet on-screen; `visibleFloatingFrame()`
([`MenubarApp.swift:581`](../../../apps/menubar/Sources/MenubarApp.swift)).
...
([`CodexPet.swift:299`](../../../apps/menubar/Sources/CodexPet.swift)).
...
([`CodexPet.swift:342`](../../../apps/menubar/Sources/CodexPet.swift)).
...
when the data can't be trusted ([`MenubarRenderer.swift:160`](../../../apps/menubar/Sources/MenubarRenderer.swift)).
...
- **`SKView`** — the `NSView` that renders a scene (the bridge from AppKit into
  ...
  ([`FloatingPetPanel.swift:1762`](../../../apps/menubar/Sources/FloatingPetPanel.swift)),
  with `allowsTransparency = true` so the pet floats over a clear panel
  ([:1814](../../../apps/menubar/Sources/FloatingPetPanel.swift)), presented via
  `skView.presentScene(scene)` ([:1832](../../../apps/menubar/Sources/FloatingPetPanel.swift)).
- **`SKScene`** — the per-frame render/update surface; you subclass it. Ours:
  [`FloatingPetScene.swift:86`](../../../apps/menubar/Sources/FloatingPetScene.swift).
- **`SKSpriteNode`** — a node that displays a texture (the pet itself; also the
  glow/sparkle/fly effects). Ours: `spriteNode` ([:97](../../../apps/menubar/Sources/FloatingPetScene.swift)).
- **`SKTexture`** — the image a node draws; built per animation frame from a
  `CGImage` via `SKTexture(cgImage:)` ([:588](../../../apps/menubar/Sources/FloatingPetScene.swift)).
...
decode in [`StateJsonReader.swift`](../../../apps/menubar/Sources/StateJsonReader.swift);
`FloatingAppState` round-trips `app-state.json` in
[`AppState.swift`](../../../apps/menubar/Sources/AppState.swift). `ActivityState`
...
poll in `LivePollingDriver.start()` ([:166](../../../apps/menubar/Sources/LivePollingDriver.swift));
...
that re-clamps the pet ([`FloatingPetController.swift:66`](../../../apps/menubar/Sources/FloatingPetController.swift));
the **wake-from-sleep** observer that triggers an immediate poll
([`MenubarApp.swift:397`](../../../apps/menubar/Sources/MenubarApp.swift)).
🇹🇸 ≈ `EventEmitter` / `window.addEventListener`. ⚠️ **Gotcha:** you must
`removeObserver` on teardown ([`MenubarApp.swift:479`](../../../apps/menubar/Sources/MenubarApp.swift),
...
([`MenubarApp.swift:425`](../../../apps/menubar/Sources/MenubarApp.swift)).
...
([`MenubarApp.swift:514`/`:527`](../../../apps/menubar/Sources/MenubarApp.swift)).
...
@MainActor in … }` ([`MenubarApp.swift:385`](../../../apps/menubar/Sources/MenubarApp.swift)).
