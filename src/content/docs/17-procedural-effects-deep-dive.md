---
title: "17 — Procedural Effects Deep-Dive"
---
...
>
> 🗣️ **In plain English.** The pet's flashiest moments — level-up fireworks,
> sparkles, glows — use no drawn artwork at all. The app *generates* those
> visuals with math at runtime, which is how she stays lively without anyone
> painting new frames. This chapter shows how.

> Prereq: [Ch.16](./16-macos-primitives-primer.md)'s SpriteKit section
...
[`FloatingPetScene.swift:964`](https://github.com/cesarnml/codogotchi/blob/archive/v2.5.0/apps/menubar/Sources/FloatingPetScene.swift#L964):
...
🗣️ **In plain English.** Make a 128×128 bitmap, paint a radial gradient from
*opaque-center* to *transparent-edge*, hand it to SpriteKit as a texture. That's a
soft glowing dot. `renderImage` ([:985](https://github.com/cesarnml/codogotchi/blob/archive/v2.5.0/apps/menubar/Sources/FloatingPetScene.swift#L985))
...
[:657–676](https://github.com/cesarnml/codogotchi/blob/archive/v2.5.0/apps/menubar/Sources/FloatingPetScene.swift#L657)
...
The scene has two child nodes ([:95](https://github.com/cesarnml/codogotchi/blob/archive/v2.5.0/apps/menubar/Sources/FloatingPetScene.swift#L95)):
...
**Decoded — sickness miasma** ([:739](https://github.com/cesarnml/codogotchi/blob/archive/v2.5.0/apps/menubar/Sources/FloatingPetScene.swift#L739)):
...
**Decoded — level-up fountain** ([:870](https://github.com/cesarnml/codogotchi/blob/archive/v2.5.0/apps/menubar/Sources/FloatingPetScene.swift#L870)):
...
**Decoded — firework burst** ([:935](https://github.com/cesarnml/codogotchi/blob/archive/v2.5.0/apps/menubar/Sources/FloatingPetScene.swift#L935)):
...
([`FloatingPetPanel.swift:237`](https://github.com/cesarnml/codogotchi/blob/archive/v2.5.0/apps/menubar/Sources/FloatingPetPanel.swift#L237)).
Composition ([:678](https://github.com/cesarnml/codogotchi/blob/archive/v2.5.0/apps/menubar/Sources/FloatingPetScene.swift#L678)):
...
([`FloatingPetPanel.swift:232`](https://github.com/cesarnml/codogotchi/blob/archive/v2.5.0/apps/menubar/Sources/FloatingPetPanel.swift#L232)).
Composition ([:814](https://github.com/cesarnml/codogotchi/blob/archive/v2.5.0/apps/menubar/Sources/FloatingPetScene.swift#L814)):
...
- anchors to the pet's real opaque bounds (`currentSpriteOpaqueRect`,
  [:699](https://github.com/cesarnml/codogotchi/blob/archive/v2.5.0/apps/menubar/Sources/FloatingPetScene.swift#L699)) so it sits on her
...
2. **Recolor live.** Temporarily change `sicknessWarningGlow` to bright magenta
   ([:659](https://github.com/cesarnml/codogotchi/blob/archive/v2.5.0/apps/menubar/Sources/FloatingPetScene.swift#L659)), rebuild, and
